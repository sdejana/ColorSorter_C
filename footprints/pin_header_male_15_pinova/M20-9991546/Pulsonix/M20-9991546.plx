...
//878503/1547573/2.50/15/2/Connector

(asciiHeader
	(fileUnits MM)
)
(library Library_1
	(padStyleDef "c165_h111"
		(holeDiam 1.11)
	...
	(patternDef "M20-9991546" (originalName "M20-9991546")
		(multiLayer
			(pad (padNum 1) (padStyleRef c165_h111) (pt 0, 0) (rotation 90))
			(pad (padNum 2) (padStyleRef c165_h111) (pt 2.54, 0) (rotation 90))
			(pad (padNum 3) (padStyleRef c165_h111) (pt 5.08, 0) (rotation 90))
			(pad (padNum 4) (padStyleRef c165_h111) (pt 7.62, 0) (rotation 90))
			(pad (padNum 5) (padStyleRef c165_h111) (pt 10.16, 0) (rotation 90))
			(pad (padNum 6) (padStyleRef c165_h111) (pt 12.7, 0) (rotation 90))
			(pad (padNum 7) (padStyleRef c165_h111) (pt 15.24, 0) (rotation 90))
			(pad (padNum 8) (padStyleRef c165_h111) (pt 17.78, 0) (rotation 90))
			(pad (padNum 9) (padStyleRef c165_h111) (pt 20.32, 0) (rotation 90))
			(pad (padNum 10) (padStyleRef c165_h111) (pt 22.86, 0) (rotation 90))
			(pad (padNum 11) (padStyleRef c165_h111) (pt 25.4, 0) (rotation 90))
			(pad (padNum 12) (padStyleRef c165_h111) (pt 27.94, 0) (rotation 90))
			(pad (padNum 13) (padStyleRef c165_h111) (pt 30.48, 0) (rotation 90))
			(pad (padNum 14) (padStyleRef c165_h111) (pt 33.02, 0) (rotation 90))
			(pad (padNum 15) (padStyleRef c165_h111) (pt 35.56, 0) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 1.27) (pt 38.1 1.27) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 38.1 1.27) (pt 38.1 -1.27) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 38.1 -1.27) (pt -2.54 -1.27) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 -1.27) (pt -2.54 1.27) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.54 1.27) (pt 38.1 1.27) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 38.1 1.27) (pt 38.1 -1.27) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 38.1 -1.27) (pt -2.54 -1.27) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.54 -1.27) (pt -2.54 1.27) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -3.74 2.47) (pt 39.3 2.47) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 39.3 2.47) (pt 39.3 -2.47) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 39.3 -2.47) (pt -3.74 -2.47) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -3.74 -2.47) (pt -3.74 2.47) (width 0.05))
		)
	)
	(symbolDef "M20-9991546" (originalName "M20-9991546")
	...
	(compDef "M20-9991546" (originalName "M20-9991546") (compHeader (numPins 15) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "M20-9991546"))
		(attachedPattern (patternNum 1) (patternName "M20-9991546")
			(numPads 15)
			(padPinMap
		...
		(attr "Mouser Part Number" "855-M20-9991546")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Harwin/M20-9991546?qs=WS5Jv%252B%252Bx1qX3IVqZ80aaDQ%3D%3D")
		(attr "Manufacturer_Name" "Harwin")
		(attr "Manufacturer_Part_Number" "M20-9991546")
		(attr "Description" "2.54mm (0.1") Pitch SIL Vertical Throughboard Pin Header, 6.1mm mating pin height, tin, 15 contacts")
		(attr "<Hyperlink>" "https://cdn.harwin.com/pdfs/M20-999.pdf")
		(attr "<Component Height>" "8.74")
		(attr "<STEP Filename>" "M20-9991546.stp")
		(attr "<STEP Offsets>" "X=-2.54;Y=0;Z=0")
