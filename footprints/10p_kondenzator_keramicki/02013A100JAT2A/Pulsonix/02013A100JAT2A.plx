...
//275282/1547573/2.50/2/3/Capacitor
...
(library Library_1
	(padStyleDef "r47_44"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 0.44) (shapeHeight 0.47))
	...
	(patternDef "CAPC0603X33N" (originalName "CAPC0603X33N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r47_44) (pt -0.335, 0) (rotation 90))
			(pad (padNum 2) (padStyleRef r47_44) (pt 0.335, 0) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -0.72 0.37) (pt 0.72 0.37) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 0.72 0.37) (pt 0.72 -0.37) (width 0.05))
		)
	...
	(symbolDef "02013A100JAT2A" (originalName "02013A100JAT2A")
	...
	(compDef "02013A100JAT2A" (originalName "02013A100JAT2A") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "02013A100JAT2A"))
		...
		(attr "Mouser Part Number" "581-02013A100J")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KYOCERA-AVX/02013A100JAT2A?qs=O%2FKt6V6lEtyQY4OYcPPzbA%3D%3D")
		(attr "Manufacturer_Name" "Kyocera AVX")
		(attr "Manufacturer_Part_Number" "02013A100JAT2A")
		(attr "Description" "Multilayer Ceramic Capacitors MLCC - SMD/SMT 10PF 25volts COG C0G")
		(attr "<Hyperlink>" "")
		(attr "<Component Height>" "0.33")
		(attr "<STEP Filename>" "02013A100JAT2A.stp")
