...
//298418/1547573/2.50/2/2/Capacitor
...
(library Library_1
	...
	(symbolDef "C0805C106M4PACTU" (originalName "C0805C106M4PACTU")
	...
	(compDef "C0805C106M4PACTU" (originalName "C0805C106M4PACTU") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "C0805C106M4PACTU"))
		...
		(attr "Mouser Part Number" "80-C0805C106M4P")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KEMET/C0805C106M4PACTU?qs=KHg1sw%2FVM5StZkWXuKrj7w%3D%3D")
		(attr "Manufacturer_Name" "KEMET")
		(attr "Manufacturer_Part_Number" "C0805C106M4PACTU")
		(attr "Description" "SMD Comm X5R, Ceramic, 10 uF, 20%, 16 VDC, 40 VDC, 85C, -55C, X5R, SMD, MLCC, Temperature Stable, Class II, 10 % , 10 MOhms, 21 mg, 0805, 2mm, 1.25mm, 1.25mm, 0.75mm, 0.5mm, 3000, 78  Weeks, 70")
		(attr "<Hyperlink>" "https://content.kemet.com/datasheets/KEM_C1006_X5R_SMD.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "C0805C106M4PACTU.stp")
